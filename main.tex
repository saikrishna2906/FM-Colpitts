...
\twocolumn[%
  \centering
  {\Large\bfseries FM Colpitts Oscillator Transmitter\\[4pt]
   Design, Implementation, and Analysis}\\[6pt]
  {\normalsize
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/waveform.png}
...
\begin{figure}[H]
    \centering
	\includegraphics[width=0.5\linewidth]{figs/air_coil.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.4\linewidth]{figs/fm_colpitts.png}
    \caption{FM Colpitts}
    \label{fig:placeholder}
\end{figure}
\end{document}
